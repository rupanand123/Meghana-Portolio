        ...
        <div className="max-w-7xl mx-auto h-20 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-10 text-[11px] uppercase tracking-[2px] font-bold">
            ...
            <div className="flex items-center space-x-4 border-l border-white/10 pl-10">
              <a href={resumeData.contact.github} target="_blank" rel="noreferrer" className="text-white/40 hover:text-white transition-colors">
                <Github size={16} />
              </a>
              <a href={resumeData.contact.linkedin} target="_blank" rel="noreferrer" className="text-white/40 hover:text-white transition-colors">
                <Linkedin size={16} />
              </a>
            </div>
            <button 
              ...
              className="px-4 py-2 bg-brand-primary text-[#0A0A0A] hover:bg-white transition-all ml-4 uppercase text-[10px] font-bold tracking-widest"
            >
              Download CV
            </button>
          </div>
        ...
        <section id="skills" className="py-32 border-t border-white/10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 mt-12 text-center md:text-left">
            {[
              ...
              { label: "Interests", items: resumeData.interests }
            ].map((cat, i) => (
              <div key={i}>
